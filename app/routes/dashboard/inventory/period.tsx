...
export default function InventoryPeriodDetailPage() {
  ...
  const [snapshotType, setSnapshotType] = useState<"beginning" | "ending">(
    "beginning"
  );
  const [showCopyDialog, setShowCopyDialog] = useState(false);
  const [copyToType, setCopyToType] = useState<"beginning" | "ending">(
    "beginning"
  );
  ...
  const beginningSnapshots = allSnapshots.filter(
    (s) => s.snapshotType === "BEGINNING"
  );
  const endingSnapshots = allSnapshots.filter(
    (s) => s.snapshotType === "ENDING"
  );

  const beginningTotal = beginningSnapshots.reduce(
    (sum, s) => sum + s.quantity * s.unitCost,
    0
  );
  const endingTotal = endingSnapshots.reduce(
    (sum, s) => sum + s.quantity * s.unitCost,
    0
  );
    ...
    <div className="space-y-6">
      ...
      <Dialog open={showAddDialog} onOpenChange={setShowAddDialog}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>
              Add {snapshotType === "beginning" ? "Beginning" : "Ending"}{" "}
              Inventory Item
            </DialogTitle>
            <DialogDescription>
          ...
          <div className="space-y-4 py-4">
            ...
            <div className="space-y-2">
              ...
              <Select
                value={newSnapshot.ingredientId}
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  setNewSnapshot({ ...newSnapshot, itemName: e.target.value })
                }
              />
            </div>
            ...
            <div className="grid gap-4 grid-cols-2">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setNewSnapshot({ ...newSnapshot, quantity: e.target.value })
                  }
                />
              </div>
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setNewSnapshot({ ...newSnapshot, unitCost: e.target.value })
                  }
                />
              </div>
            </div>
      ...
      <Dialog open={showCopyDialog} onOpenChange={setShowCopyDialog}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Copy all your ingredients as inventory snapshots. This will help
              you quickly set up your inventory.
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="space-y-4 py-4">
            <div className="space-y-2">
              ...
              <Select
                value={copyToType}
                onValueChange={(value: "beginning" | "ending") =>
                  setCopyToType(value)
                }
              >
                <SelectTrigger>
            ...
            <div className="bg-gray-50 rounded-lg p-4">
              <p className="text-sm text-gray-600">
                This will create {ingredients.length} inventory snapshot(s) from
                your ingredients list. You can edit the quantities afterwards.
              </p>
            </div>
          </div>
