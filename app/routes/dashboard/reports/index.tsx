        ...
        <TabsContent value="cogs" className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Breakdown of production costs per recipe</CardDescription>
            </CardHeader>
            <CardContent>
              <Table>
                <TableHeader>
          ...
          <div className="grid gap-4 md:grid-cols-3">
            <Card>
              <CardContent className="pt-6">
                ...
                <p className="text-xs text-muted-foreground">Total Operating Expenses</p>
              </CardContent>
            </Card>
            <Card>
              <CardContent className="pt-6">
                  ...
                  {expenseData.length > 0 ? (
                    ...
                    <TableRow>
                      <TableCell colSpan={3} className="text-center py-8 text-muted-foreground">
                        No expense data available for this period. Add expenses to see the
                        breakdown.
                      </TableCell>
                    </TableRow>
                  )}
        ...
        <TabsContent value="income" className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Profit and loss summary for the period</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
                ...
                <div className="space-y-2 pl-4">
                  ...
                  {(incomeStatement?.operatingExpenses?.utilities ?? 0) > 0 && (
                    <div className="flex justify-between">
                      <span>Utilities</span>
                      <span>
                        {formatCurrency(incomeStatement?.operatingExpenses?.utilities ?? 0)}
                      </span>
                    </div>
                  )}
                  {(incomeStatement?.operatingExpenses?.salaries ?? 0) > 0 && (
                    <div className="flex justify-between">
                      <span>Salaries</span>
                      <span>
                        {formatCurrency(incomeStatement?.operatingExpenses?.salaries ?? 0)}
                      </span>
                    </div>
                  )}
                  {(incomeStatement?.operatingExpenses?.marketing ?? 0) > 0 && (
                    <div className="flex justify-between">
                      <span>Marketing</span>
                      <span>
                        {formatCurrency(incomeStatement?.operatingExpenses?.marketing ?? 0)}
                      </span>
                    </div>
                  )}
                  {(incomeStatement?.operatingExpenses?.supplies ?? 0) > 0 && (
                    <div className="flex justify-between">
                      <span>Supplies</span>
                      <span>
                        {formatCurrency(incomeStatement?.operatingExpenses?.supplies ?? 0)}
                      </span>
                    </div>
                  )}
                  {(incomeStatement?.operatingExpenses?.maintenance ?? 0) > 0 && (
                    <div className="flex justify-between">
                      ...
                      <span>
                        {formatCurrency(incomeStatement?.operatingExpenses?.maintenance ?? 0)}
                      </span>
                    </div>
                  )}
                  {(incomeStatement?.operatingExpenses?.insuranceLicenses ?? 0) > 0 && (
                    <div className="flex justify-between">
                      ...
                      <span>
                        {formatCurrency(incomeStatement?.operatingExpenses?.insuranceLicenses ?? 0)}
                      </span>
                    </div>
                  )}
                  {(incomeStatement?.operatingExpenses?.miscellaneous ?? 0) > 0 && (
                    <div className="flex justify-between">
                      ...
                      <span>
                        {formatCurrency(incomeStatement?.operatingExpenses?.miscellaneous ?? 0)}
                      </span>
                    </div>
                  )}
                  <div className="flex justify-between font-semibold border-t pt-2">
                    <span>Total Operating Expenses</span>
                    <span>{formatCurrency(incomeStatement?.operatingExpenses?.total ?? 0)}</span>
                  </div>
                </div>
              </div>
              ...
              >
                ...
                <div className="flex justify-between text-sm mt-2 text-muted-foreground">
                  ...
                  <span>{(incomeStatement?.netProfitMargin ?? 0).toFixed(2)}%</span>
                </div>
              </div>
            </CardContent>
          </Card>
        ...
        <TabsContent value="profit" className="space-y-6">
          <div className="grid gap-4 md:grid-cols-4">
            ...
            <Card>
              <CardContent className="pt-6">
                ...
                <p className="text-xs text-muted-foreground">Profitable Recipes</p>
              </CardContent>
            </Card>
          </div>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Profit margin analysis for each recipe</CardDescription>
            </CardHeader>
            <CardContent>
              <Table>
                <TableHeader>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Suggestions to improve profitability</CardDescription>
            </CardHeader>
            <CardContent>
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground mt-1">
                          ...
                          or reducing ingredient/labor costs to achieve profitability.
                        </p>
                      </div>
                    </div>
                  ))}
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p className="text-sm text-yellow-700 mt-1">
                          With only {recipe.profitMargin.toFixed(2)}% margin, consider optimizing
                          costs or adjusting pricing to achieve a healthier 20%+ margin.
                        </p>
                      </div>
                    </div>
                  ))}
                ...
                {profitData.every((r) => r.profitMargin >= 20) && (
                  <div className="flex items-start gap-3 p-3 rounded-lg bg-lightgreenz/10 border border-lightgreenz/20">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground mt-1">
                        Great job! All your recipes have healthy profit margins above 20%.
                      </p>
                    </div>
                  </div>
                )}
              ...
              <div>
                ...
                <p
                  className={`text-2xl font-semibold ${
                    (netProfit?.netProfit || 0) >= 0 ? 'text-green-600' : 'text-red-600'
                  }`}
                >
            ...
            <CollapsibleTrigger className="flex items-center justify-between w-full">
              <div className="flex items-center gap-2">
                ...
                <div className="text-left">
                  <CardTitle className="text-gray-900">Income Statement</CardTitle>
                ...
                <div>
                  ...
                  <div className="bg-gray-50 rounded-lg p-4 space-y-2">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">
                        {formatCurrency(incomeStatement?.revenue?.beverageSales)}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-600">Catering</span>
                      <span className="font-medium">
                        {formatCurrency(incomeStatement?.revenue?.cateringSales)}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-600">Delivery</span>
                      <span className="font-medium">
                        {formatCurrency(incomeStatement?.revenue?.deliverySales)}
                      </span>
                    </div>
                    <Separator />
                ...
                <div>
                  ...
                  <div className="bg-gray-50 rounded-lg p-4 space-y-2">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">{formatCurrency(cogs?.purchases?.total)}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-600">
                ...
                <div>
                  ...
                  <div className="bg-gray-50 rounded-lg p-4 space-y-2">
                    {incomeStatement?.operatingExpenses ? (
                      ...
                      <p className="text-gray-500 text-sm">No operating expenses data available</p>
                    )}
                    <Separator />
                    <div className="flex justify-between font-semibold text-purple-700">
                      <span>Total Operating Expenses</span>
                      <span>
                        {formatCurrency(incomeStatement?.operatingExpenses?.total ?? opex?.total)}
                      </span>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-purple-50 rounded-lg p-4">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-xl font-bold text-purple-700">
                      {formatCurrency(
                        incomeStatement?.operatingIncome ?? operatingIncome?.operatingIncome
                      )}
                    </span>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="bg-gray-50 rounded-lg p-4 space-y-2">
                    ...
                    <div className="flex justify-between font-medium text-gray-700">
                      ...
                      <span>
                        {formatCurrency(
                          incomeStatement?.otherExpenses?.total ?? otherExpenses?.total
                        )}
                      </span>
                    </div>
                  </div>
              ...
              <div className="grid gap-6 md:grid-cols-2">
                ...
                <div>
                  ...
                  <div className="bg-blue-50 rounded-lg p-4 space-y-2">
                    {fixedCosts?.breakdown && Object.keys(fixedCosts.breakdown).length > 0 ? (
                      Object.entries(fixedCosts.breakdown).map(([category, amount]) => (
                      ...
                      <p className="text-gray-500 text-sm">No fixed costs recorded</p>
                    )}
                    <Separator />
                    <div className="flex justify-between font-semibold text-blue-700">
                ...
                <div>
                  ...
                  <div className="bg-green-50 rounded-lg p-4 space-y-2">
                    {variableCosts?.breakdown && Object.keys(variableCosts.breakdown).length > 0 ? (
                      Object.entries(variableCosts.breakdown).map(([category, amount]) => (
                        <div key={category} className="flex justify-between">
                          <span className="text-gray-600 capitalize">
                            {category.replace(/_/g, ' ')}
                          </span>
                      ...
                      <p className="text-gray-500 text-sm">No variable costs recorded</p>
                    )}
                    <Separator />
          ...
          <CardHeader>
            <CollapsibleTrigger className="flex items-center justify-between w-full">
              <div className="flex items-center gap-2">
                ...
                <div className="text-left">
                  <CardTitle className="text-gray-900">Recipe Costing</CardTitle>
                  <CardDescription className="text-gray-500">
                  ...
                  <div className="grid gap-4 md:grid-cols-2">
                    <div className="bg-gray-50 rounded-lg p-4 space-y-3">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium">{formatCurrency(recipeCost.laborCost)}</span>
                      </div>
                      <div className="flex justify-between">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span
                          className={`font-medium ${
                            recipeCost.profit >= 0 ? 'text-green-600' : 'text-red-600'
                          }`}
                        >
